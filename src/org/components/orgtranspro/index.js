...
import { Layout, Breadcrumb, Input, InputNumber, Form, Upload, Button, Icon, DatePicker, } from 'antd';
          ...
          <div className="trans_container">
            ...
            <div className="trans_content">
              <div className="trans_content_1">
                ...
                <div className="firstlineindent_2">因<Input className="transInput_3" />拟商调<Input className="transInput_4" />（工号<Input className="transInput_5" /><Icon type="search" />）到中国联合网络通信有限公司<Input  className="transInput_6" /><Icon type="search" />工作，请贵公司同意，请于<DatePicker className="transDatePicker_1" />日前协助办理以下调离手续。如果不同意，请于收到此函5日内函告。</div>
